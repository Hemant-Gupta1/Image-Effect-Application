...
// Function to apply Gaussian blur to an image represented by a 2D vector of Pixel objects
void gaussianBlur(std::vector<std::vector<Pixel>> &img, float radius)
{
    ...
    // Generate (2r+1 x 2r+1) kernel (from -r to r) by sampling from a 2-D Gaussian distribution
    ...
    // Copy the image into the padded vector
